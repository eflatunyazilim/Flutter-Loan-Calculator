...
class TablePage extends StatefulWidget {
  ...
  TablePage({this.creditTableList, this.creditAmount, this.creditTerm, this.interest, this.bsmv, this.kkdf, this.installment,});
...
class _TablePageState extends State<TablePage> {
  ...
  Widget dataBodyTitle(){
    return DataTable(
      columns: <DataColumn>[
        DataColumn(
            label: Text(creditAmountText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(creditTermText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(creditInterestText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(bsmvText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(kkdfText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(installmentText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
      ],
  ...
  Widget dataBody() {
    return DataTable(
      columns: <DataColumn>[
        DataColumn(
            label: Text(periodText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            ...
            onSort: (i, b) {}),
        DataColumn(
            label: Text(mainMoneyText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
            label: Text(interestText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
        DataColumn(
        ...
        DataColumn(
            ...
            onSort: (i, b) {}),
        DataColumn(
            label: Text(remainingMainMoneyText,style: TextStyle(color: Colors.black,fontSize: 16),),
            numeric: false,
            tooltip: "",
            onSort: (i, b) {}),
      ],
      rows: widget.creditTableList
          .map((dataRow) => DataRow(cells: [
                DataCell(
                  Text((widget.creditTableList.indexOf(dataRow)+1).toString()),
                  showEditIcon: false,
                  placeholder: false,
                ),
                DataCell(
